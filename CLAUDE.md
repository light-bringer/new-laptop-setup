...
2. **bin/laptop.run** → Installs Ansible via Homebrew, installs Ansible dependencies (roles & collections from requirements.yml), configures Python environment, runs `ansible-playbook main.yml`
